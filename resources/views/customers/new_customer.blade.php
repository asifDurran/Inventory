...
<form method="post" action="{{route('customers.store')}}">
  <div class="form-group">
    ...
    <input type="text" class="form-control"  name="name" id="formGroupExampleInput" placeholder="Customer Name">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="address" class="form-control" name ="address" id="formGroupExampleInput2" placeholder=" Customer Address ">
  </div>
